...
MTL::RenderPipelineState* PipelineBuilder::build() {
    ...
    NS::String* vertexName = NS::String::string(vertexEntryPoint, NS::StringEncoding::UTF8StringEncoding);
    MTL::Function* vertexMain = library->newFunction(vertexName);

    NS::String* fragmentName = NS::String::string(fragmentEntryPoint, NS::StringEncoding::UTF8StringEncoding);
